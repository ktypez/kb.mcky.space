...
// Copy graph.json to public/ if exists (generated by MCP render tool)
const graphJson = path.join(OKF_ROOT, 'mcp-server', 'out', 'graph.json');
const publicDir = path.resolve(import.meta.dirname, '../public');
if (fs.existsSync(graphJson)) {
  fs.copyFileSync(graphJson, path.join(publicDir, 'graph.json'));
  console.log('  Copied graph.json → public/');
}
