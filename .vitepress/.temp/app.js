...
const siteData = deserializeFunctions(JSON.parse('{"lang":"th","dir":"ltr","title":"OKF Knowledge Base","description":"Open Knowledge Framework — structured context for every project","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"src":"/favicon.svg","width":24,"height":24},"search":{"provider":"local"},"sidebar":[{"text":"Index","link":"/"},{"text":"Setup","link":"/setup"},{"text":"System","collapsed":false,"items":[{"text":"Conventions","link":"/system/conventions"},{"text":"Glossary","link":"/system/glossary"},{"text":"Personalities","link":"/system/personalities"},{"text":"Sync Log","link":"/system/sync-log"},{"text":"TODOS","link":"/system/TODOS"}]},{"text":"Projects","collapsed":true,"items":[{"text":"clientdata","items":[{"text":"Agent","link":"/projects/clientdata/agent"},{"text":"Profile","link":"/projects/clientdata/profile"},{"text":"Status","link":"/projects/clientdata/status"}]},{"text":"collage","items":[{"text":"Agent","link":"/projects/collage/agent"},{"text":"Profile","link":"/projects/collage/profile"},{"text":"Status","link":"/projects/collage/status"}]},{"text":"data-mcky-space","items":[{"text":"Agent","link":"/projects/data-mcky-space/agent"},{"text":"Profile","link":"/projects/data-mcky-space/profile"},{"text":"Status","link":"/projects/data-mcky-space/status"}]},{"text":"habby","items":[{"text":"Agent","link":"/projects/habby/agent"},{"text":"Profile","link":"/projects/habby/profile"},{"text":"Status","link":"/projects/habby/status"}]},{"text":"mcky-space","items":[{"text":"Agent","link":"/projects/mcky-space/agent"},{"text":"Profile","link":"/projects/mcky-space/profile"},{"text":"Status","link":"/projects/mcky-space/status"}]},{"text":"receipts-dms","items":[{"text":"Agent","link":"/projects/receipts-dms/agent"},{"text":"Profile","link":"/projects/receipts-dms/profile"},{"text":"Status","link":"/projects/receipts-dms/status"}]},{"text":"truck","items":[{"text":"Agent","link":"/projects/truck/agent"},{"text":"Profile","link":"/projects/truck/profile"},{"text":"Status","link":"/projects/truck/status"}]},{"text":"writer","items":[{"text":"Agent","link":"/projects/writer/agent"},{"text":"Profile","link":"/projects/writer/profile"}]}]},{"text":"Plans","collapsed":true,"items":[{"text":"Data To Cloudflare Pages","link":"/plans/data-to-cloudflare-pages"},{"text":"Rose Pine Theme Switch","link":"/plans/rose-pine-theme-switch"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/ktypez/OKF"}],"footer":{"message":"Open Knowledge Framework","copyright":"MIT License"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DXIoGz5l.js"));
