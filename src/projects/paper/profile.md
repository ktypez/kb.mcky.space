...
| `npx wrangler pages deploy --project-name paper ./dist` | Deploy ไป Cloudflare Pages |
...
| `npx wrangler pages secret put AUTH_PASSWORD --project-name paper` | ตั้งรหัสผ่าน auth |
| `npx wrangler pages secret put AUTH_SECRET --project-name paper` | ตั้ง HMAC secret สำหรับ auth |
