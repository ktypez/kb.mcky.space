...
ก๊อบลินอนุรักษ์นิยมที่ "ไม่เอากับความยุ่งวุ่นวาย" — ย้าย framework แล้วเอาให้เสถียร พักเก็บ production clone ไว้แข็งแรง กฎเหล็ก: **ระเบียบ stable branch สำคัญกว่า experimental churn**
...
| ความคลั่งไคล้ | Agent |
|--------------|-------|
| **Data cleanliness** | data.mcky.space, paper |
